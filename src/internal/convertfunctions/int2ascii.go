...
func Int82AsciiToCan(input []byte) (can.Frame, error) {
	return NIntM2AsciiToCan(1, 8, input)
}

func Int82AsciiToMqtt(input can.Frame) ([]byte, error) {
	return NIntM2AsciiToMqtt(1, 8, input)
}

func Int162AsciiToCan(input []byte) (can.Frame, error) {
	return NIntM2AsciiToCan(1, 16, input)
}

func Int162AsciiToMqtt(input can.Frame) ([]byte, error) {
	return NIntM2AsciiToMqtt(1, 16, input)
}

func Int322AsciiToCan(input []byte) (can.Frame, error) {
	return NIntM2AsciiToCan(1, 32, input)
}

func Int322AsciiToMqtt(input can.Frame) ([]byte, error) {
	return NIntM2AsciiToMqtt(1, 32, input)
}

func Int642AsciiToCan(input []byte) (can.Frame, error) {
	return NIntM2AsciiToCan(1, 64, input)
}

func Int642AsciiToMqtt(input can.Frame) ([]byte, error) {
	return NIntM2AsciiToMqtt(1, 64, input)
}

func TwoInt322AsciiToCan(input []byte) (can.Frame, error) {
	return NIntM2AsciiToCan(2, 32, input)
}

func TwoInt322AsciiToMqtt(input can.Frame) ([]byte, error) {
	return NIntM2AsciiToMqtt(2, 32, input)
}

func EightInt82AsciiToCan(input []byte) (can.Frame, error) {
	return NIntM2AsciiToCan(8, 8, input)
}

func EightInt82AsciiToMqtt(input can.Frame) ([]byte, error) {
	return NIntM2AsciiToMqtt(8, 8, input)
}

func FourInt82AsciiToCan(input []byte) (can.Frame, error) {
	return NIntM2AsciiToCan(4, 8, input)
}

func FourInt82AsciiToMqtt(input can.Frame) ([]byte, error) {
	return NIntM2AsciiToMqtt(4, 8, input)
}

func FourInt162AsciiToCan(input []byte) (can.Frame, error) {
	return NIntM2AsciiToCan(4, 16, input)
}

func FourInt162AsciiToMqtt(input can.Frame) ([]byte, error) {
	return NIntM2AsciiToMqtt(4, 16, input)
}

// NIntM2AsciiToCan is the generic approach to convert numberAmount occurrences of numbers with numberWidth bits size.
...
func NIntM2AsciiToCan(numberAmount, numberWidth uint, input []byte) (can.Frame, error) {
	...
	for i := uint(0); i < numberAmount; i++ {
		res, err := strconv.ParseInt(splitInput[i], 10, int(numberWidth))
		if err != nil {
...
// NIntM2AsciiToMqtt is the generic approach to convert numberAmount occurrences of numbers with numberWidth bits size.
// Allowed values for numberAmount are 1-8.
// Allowed values for numberWidth are 8, 16, 32 or 64
// numberAmount*numberWidth shall not be larger than 64
...
func NIntM2AsciiToMqtt(numberAmount, numberWidth uint, input can.Frame) ([]byte, error) {
	if !(numberWidth == 8 || numberWidth == 16 || numberWidth == 32 || numberWidth == 64) {
